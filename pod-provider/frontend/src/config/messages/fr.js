...
module.exports = {
  app: {
    action: {
      ...
      link_atproto_account: 'Lier votre compte ATProto',
      continue_to_bluesky: 'Continuer vers Bluesky',
      atproto_link_starting: 'Démarrage de la liaison...',
      ...
      add_profile_field: 'Ajouter un champ de profil',
    ...
    page: {
      ...
      settings_atproto_link: 'Lier un compte ATProto',
    ...
    setting: {
      ...
      locale: 'Langue',
      atproto_link: 'Compte ATProto',
      atproto_link_description: 'Lier un compte ATProto externe existant',
    ...
    input: {
      ...
      message: 'Message',
      atproto_pds_url: 'URL du PDS ATProto',
      atproto_identifier_optional: 'Identifiant ATProto (optionnel)',
      atproto_did_optional: 'DID ATProto (optionnel)',
      atproto_handle_optional: 'Handle ATProto (optionnel)',
      user_id: 'Identifiant utilisateur',
      email: 'Email',
      current_password: 'Mot de passe actuel',
      atproto_link_activitypods_password: 'Votre mot de passe MyPod.local',
    ...
    notification: {
      ...
      signup_network_error: 'Erreur réseau. Veuillez réessayer.',
      ...
      profile_metadata_verification_summary: '%{verified} lien(s) vérifié(s) sur %{total}',
