...
Use a random token of at least 32 bytes of entropy encoded with characters safe for a Bearer credential. For example, generate a deployment secret with your secret manager or a cryptographically secure random generator; never use the examples or test fixtures as production credentials.
